...
# Reading XML Files
XML stands for *"Extensible Markup Language"*. For more information see [wiki_xml](https://en.wikipedia.org/wiki/XML#Key_terminology). We start by downloading and loading the `XML` package. Then reading the xml file with `xmlTreeParse`.
```{r}
library(XML)
